...
public class FirstfloorRooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Hostel DB").child("Room Details").child("firstfloor");
        list=new ArrayList<>();
