...
public class SecondFloorRooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Hostel DB").child("Room Details").child("secondfloor");
        list=new ArrayList<>();
