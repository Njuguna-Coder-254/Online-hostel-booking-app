...
public class ThirdFloorRooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Hostel DB").child("Room Details").child("thirdfloor");
        list=new ArrayList<>();
