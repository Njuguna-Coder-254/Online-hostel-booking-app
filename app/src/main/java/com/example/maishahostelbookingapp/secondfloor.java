...
public class secondfloor extends AppCompatActivity {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(room.isEmpty() && capacity.isEmpty() && amount.isEmpty()){
                    Toast.makeText(secondfloor.this,"all fields required",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void insertDetails(String room, String capacity, String amount) {
        ...
        reference = rootNode.getReference("Hostel DB").child("Room Details").child("secondfloor");
        ...
        reference.child(room).setValue(senderModel).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(secondfloor.this, "successful", Toast.LENGTH_SHORT).show();
                    //firebaseUser.sendEmailVerification();
                    Intent intent = new Intent(secondfloor.this, AdminDashboard.class);
                    //intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);

                } else {
                    Toast.makeText(secondfloor.this, "failed,try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
